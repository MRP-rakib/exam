            ...
            <div className='container relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 lg:gap-[24px] pt-[100px] '>
                    ...
                    <div className=' pb-10 md:pb-[140px]'>
                        ...
                        <h2 className='text-[30px] md:text-[40px] lg:text-[64px] font-syne font-bold leading-[40px] lg:leading-[72px]  relative before:rounded-full before:bg-amber-400 before:block before:absolute before:top-[24%] before:left-[-5px] before:-z-[1] before:w-[30px] lg:before:w-[50px] xl:before:w-[70px] before:h-[30px] lg:before:h-[50px] xl:before:h-[70px] before:translate-y-[-50%] z-2'>All over my details find here...</h2>
