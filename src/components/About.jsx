            ...
            <div className='container relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 lg:gap-[100px] pt-[100px] '>
                    ...
                    <div className=' pb-[140px]'>
                        ...
                        <ul className='mr-40 mt-[18px]  '>
                            <li className='flex justify-between mb-2 py-5 px-6 rounded-2xl text-[16px] font-bold leading-[15px] hover:bg-black hover:text-white duration-75 items-center bg-white'>About <span><MdArrowOutward/></span></li>
                            <li className='flex justify-between mb-2 py-5 px-6 rounded-2xl text-[16px] font-bold leading-[15px] hover:bg-black hover:text-white duration-75 items-center bg-white'>Experience <span><MdArrowOutward/></span></li>
                            <li className='flex justify-between mb-2 py-5 px-6 rounded-2xl text-[16px] font-bold leading-[15px] hover:bg-black hover:text-white duration-75 items-center bg-white'>Education <span><MdArrowOutward/></span></li>
                            <li className='flex justify-between mb-2 py-5 px-6 rounded-2xl text-[16px] font-bold leading-[15px] hover:bg-black hover:text-white duration-75 items-center bg-white'>Skills <span><MdArrowOutward/></span></li>
                            <li className='flex justify-between mb-2 py-5 px-6 rounded-2xl text-[16px] font-bold leading-[15px] hover:bg-black hover:text-white duration-75 items-center bg-white'>Awards <span><MdArrowOutward/></span></li>
                        </ul>
                    </div>
                    {/* right side  */}
                    <div className='mt-2'>
