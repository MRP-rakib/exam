      ...
      <div className="container relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-[24px] pt-[100px] ">
          ...
          >
            ...
            <h2 className="text-[30px] md:text-[40px] lg:text-[64px] font-syne font-bold leading-[40px] lg:leading-[72px]  relative before:rounded-full before:bg-amber-400 before:block before:absolute before:top-[24%] before:left-[-5px] before:-z-[1] before:w-[30px] lg:before:w-[50px] xl:before:w-[70px] before:h-[30px] lg:before:h-[50px] xl:before:h-[70px] before:translate-y-[-50%] z-2">
    ...
    <div className="mt-2">
      <div>
        <div className="max-w-[636px] mr-[68px]">
          <h2 className="font-bold font-syne text-[22px] md:text-[26px] lg:text-[32px] leading-6 md:leading-8 lg:leading-10 pb-10">
            Product Designer
          </h2>
          <p className="text-[18px] font-normal leading-7 pb-6">
            Mark Henry, <span className="font-bold pb-6">Product Designer</span>
            , based in German. That is where I come in. A lover of words, a
            wrangler of copy. Here to create copy that not only reflects who you
        ...
        <ul className="mt-[56px] flex-col gap-3 inline-flex">
          <li className=" gap-10 inline-flex items-center">
            <span className="w-[110px] text-black text-lg font-normal leading-none">
              Name
            </span>
          ...
          <li className=" gap-10 inline-flex items-center">
            ...
            <span className="text-black lg:text-2xl font-bold font-syne leading-8">
              hello@henry.com
            </span>
          </li>
          <li className=" gap-10 inline-flex items-center">
            ...
            <span className="text-black text-2xl font-bold font-syne leading-8">
              2+ Years
            </span>
          </li>
          <li className=" gap-10 inline-flex items-center">
...
const Experience = () => {
  return (
    <>
      <h1 className="font-bold font-syne text-[24px] md:text-[32px] leading-[24px] md:leading-[32px] pb-6">
        Experience
      </h1>
    ...
    <div>
      ...
      <div className="bg-gray-100 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex  gap-4 py-6 px-5 bg-[#0808080A]">
          ...
          <div className="">
            <h2 className="font-bold font-syne text-[20px] leading-7 pb-1">
              React Js
            </h2>
