      ...
      <div className="container ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[55px]">
          ...
          <div>
            ...
            <h1 className="text-[26px] lg:text-[64px]  font-syne text-black-800  xl:text-[80px] font-bold font-Syne leading-none  relative before:rounded-full before:bg-amber-400 before:block before:absolute before:top-[18%] before:left-[-2px] before:-z-[1] before:w-[30px] lg:before:w-[80px] xl:before:w-[90px] before:h-[30px] lg:before:h-[100px] xl:before:h-[90px] before:translate-y-[-50%] z-2 ">Mark Henry,  <span className="flex flex-col">Product</span> Designer </h1>
            <h3 className="text-[24px] md:text-[40px] lg:text-[44px] leading-[54px] font-bold font-syne">Based in German</h3>
            ...
            <button className="flex items-center gap-3 bg-black text-white text-[15px] leading-[15px] font-bold py-3 lg:py-5 lg:px-8 px-5 rounded-[10px] mt-12 hover:bg-transparent hover:text-black border-2 border-black">Download My Resume <span><MdArrowOutward/></span></button>
          </div>
        </div>
      </div>
    </section>
